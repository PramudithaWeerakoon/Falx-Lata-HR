...
const WhyUsSectionV2 = () => {
    ...
    // Features data using your original content
    const reasons = [
        {
    ...
    return (
        <section ref={sectionRef} className="relative py-20 overflow-hidden bg-gradient-to-b from-gray-50 to-white">
            ...
            >
                <div
                    className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-100 to-teal-100 rounded-full opacity-20 blur-3xl transform translate-x-1/2 -translate-y-1/3"></div>
                <div
                    className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-purple-100 to-pink-100 rounded-full opacity-20 blur-3xl transform -translate-x-1/3 translate-y-1/4"></div>
                <div
                    className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-r from-yellow-100 to-orange-100 rounded-full opacity-20 blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
            </motion.div>
                    ...
                    {reasons.map((reason, index) => (
                        ...
                        >
                            <div className="flex flex-col items-center">
                                <div
                                    className={`w-16 h-16 flex items-center justify-center rounded-full bg-white shadow-sm mb-5 border border-gray-200`}>
                                    <svg
                                        ...
                                        strokeWidth={1.5}
                                        stroke="currentColor"
                                        className={`w-8 h-8 ${reason.color}`}
                                    >
            ...
            {[...Array(5)].map((_, i) => (
                <motion.div
                    ...
                    className={`absolute rounded-full ${
                        i % 3 === 0 ? 'bg-blue-200' :
                            i % 2 === 0 ? 'bg-purple-200' : 'bg-teal-200'
                    }`}
                    style={{
...
const SectionHeader = ({title, subtitle, description}) => (
    <div className="text-center mb-16">
        <motion.span
            ...
            className="inline-block text-sm font-semibold text-blue-600 mb-2"
        >
            {subtitle}
        </motion.span>
        <motion.h2
                ...
                >
                    ...
                    <Link href="/about"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                             className="h-5 w-5 ml-1 group-hover:translate-x-1 transition-transform" viewBox="0 0 20 20"
                             fill="currentColor">
        ...
        <div className="py-16 bg-gray-50">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <span className="inline-block text-sm font-semibold text-blue-600 mb-2">OUR SERVICES</span>
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Comprehensive HR Solutions</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <a href="#"
                               className="inline-flex items-center mt-4 text-blue-600 text-sm font-medium group">
                                Learn more
                                <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="text-center mt-12">
                    <Link href="/services">
                        <button
                            className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1">
                            View All Services
                        </button>
                    </Link>
                </div>
...
function IndustryCard({industry, icon}) {
    return (
        <motion.div
            ...
            viewport={{once: true}}
            className="text-center p-6 rounded-xl border border-gray-200 hover:border-blue-500/30 hover:shadow-lg transition-all duration-300 bg-white group hover:-translate-y-2"
        >
            <div
                className="w-16 h-16 mx-auto rounded-full bg-blue-50 flex items-center justify-center mb-4 text-blue-600 group-hover:bg-blue-500/10 transition-all duration-300">
                {icon}
            </div>
            <h3 className="font-medium text-gray-900 group-hover:text-blue-600 transition-all duration-300">{industry}</h3>
        </motion.div>
    );
}
...
function IndustriesSection() {
    ...
    return (
        <div className="bg-white py-16">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <span className="inline-block text-sm font-semibold text-blue-600 mb-2">INDUSTRIES WE SERVE</span>
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Specialized HR Solutions Across
                        Industries</h2>
                    <div className="w-24 h-1 bg-yellow-400 mx-auto mb-6"></div>
...
function WhyChooseUsSection() {
    ...
    return (
        <div className="py-16 bg-gray-50">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <span className="inline-block text-sm font-semibold text-blue-600 mb-2">WHY CHOOSE US</span>
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Competitive Advantages</h2>
                    <div className="w-24 h-1 bg-yellow-400 mx-auto mb-6"></div>
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        At Falx Lata, we're committed to providing exceptional HR solutions that empower your business
                        growth.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {reasons.map((reason, index) => (
                        ...
                        >
                            <div
                                className={`w-12 h-12 rounded-full ${reason.color.replace('text', 'bg')}/10 flex items-center justify-center mb-4`}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 ${reason.color}`}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d={reason.icon}/>
                                </svg>
                            </div>
    ...
    return (
        <SectionWrapper bgColor="bg-gray-50">
            <div
                ...
                <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-purple-400 rounded-full opacity-20"></div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/contact">
                            <motion.button
                                whileHover={{scale: 1.05}}
                                whileTap={{scale: 0.95}}
                                className="bg-white hover:bg-gray-100 text-blue-700 font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                            >
