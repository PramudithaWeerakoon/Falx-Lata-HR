...
const AnimatedDividerSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-[70vh] md:h-[80vh] w-full overflow-visible text-black"
      style={{
        position: "relative",
        zIndex: 1
      }}
    >
      ...
      {/* Full page background container that extends beyond section boundaries */}
      <div className="absolute inset-0 -top-50 -bottom-20 z-0" 
        style={{
      ...
      <div className="absolute -bottom-20 left-0 right-0 w-full z-50">
        <img 
