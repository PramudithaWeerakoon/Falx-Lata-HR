...
export default function ServicesSection() {    // Service offerings with images
    const serviceOfferings = [
        ...
        },
        {
            ...
            <div className="container mx-6 px-4 md:px-6 lg:px-10 xl:px-26 relative z-15 max-w-screen-2xl">                {/* Additional top spacing */}
                <div className="h-16 md:h-24"></div>                <div className="flex flex-col lg:flex-row gap-6 md:gap-46">
                    {/* LEFT SIDE - Text Content Area */}                    <div className="w-full lg:w-2/5 lg:-ml-30 xl:-ml-0">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="lg:sticky lg:top-24"                        ><h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 pl-0">
                            ...
                            </p>                              <div className="space-y-6 mt-10">
