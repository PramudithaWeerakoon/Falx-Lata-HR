...
export default function ContactSection() {
    ...
    const [formData, setFormData] = useState({
        ...
        subject: '',
        message: '',
        inquiryType: '' // company, candidate, or other
    });
        ...
        <>
            ...
            <div className="bg-gray-50 relative overflow-hidden min-h-screen">
                ...
                <section className="relative h-[500px] md:h-[890px] mb-16">
                    ...
                    <div
                        className="absolute top-[250px] right-0 w-[36rem] h-[36rem] pointer-events-none hidden md:block z-30"
                    ...
                    <div
                        className="absolute left-0 top-[0px] w-[21rem] h-[31rem] pointer-events-none hidden md:block z-30"
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                                We're here to provide you with more information, answer any questions you may have and
                                create effective HR solutions for your organization.
                            </p>
                        </motion.div>
                        {/* Tab Navigation */}
                        <div className="flex justify-center mb-12">
                            <div
                                className="flex flex-col sm:flex-row rounded-xl bg-white p-2 shadow-lg w-120 max-w-md sm:max-w-xl">
                        ...
                        >
                            ...
                            {activeTab === 'contactForm' && (
                                <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 max-w-4xl mx-auto">
                                    ...
                                    >
                                        <div className="bg-white rounded-xl shadow-lg p-5 sm:p-8 h-full">
                                            ...
                                            <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                                                <div
                                                    className="flex items-center p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-gray-200 relative overflow-hidden hover:translate-x-1 transition-transform">
                                                    <div
                                                        className="bg-gradient-to-r from-blue-100 to-purple-100 p-2 sm:p-3 rounded-full mr-3 sm:mr-4 z-10">
                                                    ...
                                                    <div className="z-10">
                                                        ...
                                                        <p className="text-gray-900 font-medium text-sm sm:text-base">Hr@falxlata.com</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        className="bg-gradient-to-r from-blue-100 to-purple-100 p-2 sm:p-3 rounded-full mr-3 sm:mr-4 z-10">
                                                        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600"
                                                             fill="none"
                                                    ...
                                                    <div className="z-10">
                                                        ...
                                                        <p className="text-gray-900 font-medium text-sm sm:text-base">+94
                                                            777 937 691</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div className="z-10">
                                                        <p className="text-xs sm:text-sm text-gray-500">Office
                                                            Location</p>
                                                        <p className="text-gray-900 font-medium text-sm sm:text-base">Colombo,
                                                            Sri Lanka</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="pt-4 sm:pt-6 border-t border-gray-200">
                                                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Follow
                                                    Us</h4>
                                                <div className="flex space-x-3 sm:space-x-4">
                                                    <a href="#"
                                                       className="bg-gradient-to-r from-blue-500 to-purple-500 p-2 sm:p-3 rounded-full text-white hover:scale-110 transition-transform">
                                                        <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor"
                                                             viewBox="0 0 24 24">
                                                            <path
                                    ...
                                    >
                                        <div
                                            className="bg-white rounded-xl shadow-lg p-5 sm:p-8 relative overflow-hidden">
                                            ...
                                            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Send
                                                us a message</h3>
                                            ...
                                            <form onSubmit={handleSubmit}>
                                                <div
                                                    ...
                                                    <div>
                                                        <label htmlFor="name"
                                                               className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Your
                                                            Name</label>
                                                        <input
                                                            type="text"
                                                            id="name"
                                                    ...
                                                    <div>
                                                        <label htmlFor="email"
                                                               className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Email
                                                            Address</label>
                                                        <input
                                                            type="email"
                                                            id="email"
                                                ...
                                                <div className="mb-4 sm:mb-6">
                                                    <label htmlFor="subject"
                                                           className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Subject</label>
                                                    <input
                                                        type="text"
                                                        id="subject"
                                                        className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                                ...
                                                <div className="mb-4 sm:mb-6">
                                                    <label htmlFor="message"
                                                           className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Message</label>
                                                    <textarea
                                                        id="message"
                                                        rows="4"
                                                        className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                                ...
                                                <div className="mb-4 sm:mb-6">
                                                    <label
                                                        className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">I
                                                        am a...</label>
                                                    <div className="space-y-2 sm:space-y-3">
                                                        <div className="flex items-center">
                                                            ...
                                                            <label htmlFor="company"
                                                                   className="ml-2 sm:ml-3 text-sm sm:text-base text-gray-700">
                                                        ...
                                                        <div className="flex items-center">
                                                            <input
                                                                ...
                                                                name="inquiry_type"
                                                                className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 border-gray-300 focus:ring-blue-500"
                                                                checked={formData.inquiryType === 'candidate'}
                                                                onChange={handleRadioChange}
                                                            />
                                                ...
                                                <button
                                                    type="submit"
                                                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium py-2 sm:py-3 px-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                            ...
                            {activeTab === 'locations' && (
                                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                                    <div
                                        className="p-6 sm:p-8 bg-gradient-to-r from-blue-600 to-purple-600 text-center">
                                        <div
                                            className="inline-flex items-center justify-center bg-white/20 rounded-full p-3 sm:p-4 backdrop-blur-sm mb-4 sm:mb-6">
                                            ...
                                            <div className="flex flex-col md:flex-row gap-6 sm:gap-8">
                                                <div className="flex-1 max-w-lg mx-auto md:mx-0">
                                                    ...
                                                    <div
                                                        ...
                                                        <h5 className="font-semibold text-gray-900 mb-2">Colombo
                                                            Office</h5>
                                                        <p className="text-gray-700 mb-1">dehiwala, Colombo, Sri
                                                            Lanka</p>
                                                ...
                                                <div className="flex-1 max-w-lg mx-auto md:mx-0">
                                                    <div
                                                        ...
                                                        <h5 className="font-semibold text-gray-900 mb-3 sm:mb-4">Office
                                                            Hours</h5>
                                                        <div className="space-y-3">
                                                            ...
                                                            <div className="flex justify-between">
                                                                ...
                                                                <span
                                                                    className="font-medium text-gray-800">Closed</span>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div
                                                        className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-4 sm:p-6 text-white shadow-md">
                                                        <h5 className="font-semibold mb-3 sm:mb-4">Visit Us</h5>
                                                        <p className="mb-4 text-sm sm:text-base">We'd love to meet you
                                                            in person. Schedule an appointment with our team for
                                                            personalized HR consultation.</p>
                                                        <a
                                                            href="https://api.whatsapp.com/send/?phone=%2B94777937691&text&type=phone_number&app_absent=0"
                                                            target="_blank"
                                                        ...
                                                        >
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 className="h-5 w-5 ml-2" viewBox="0 0 20 20"
                                                                 fill="currentColor">
                                    ...
                                    <div className="p-4 sm:p-8">
                                            ...
                                            {[
                                                ...
                                                >
                                                    <h4 className="text-base sm:text-lg font-bold text-gray-900 mb-2 sm:mb-3 flex items-start">
                                                        <span
                                                            className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0 text-sm sm:text-base">
                                                            Q
                                                        </span>
                                                        {faq.question}
                                                    </h4>
                                        ...
                                        <div className="mt-8 sm:mt-10 text-center">
                                            ...
                                            >
                                                Contact Us Directly
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     className="h-4 w-4 sm:h-5 sm:w-5 ml-2" viewBox="0 0 20 20"
                                                     fill="currentColor">
                                                    <path fillRule="evenodd"
                                                          d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
                                                          clipRule="evenodd"/>
