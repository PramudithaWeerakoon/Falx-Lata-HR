            ...
            <div className="p-5 md:p-8 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-start gap-4 md:gap-6">
                    <div className="flex-1">
                        <motion.h3
                            whileHover={{x: 3}}
                            className="text-xl md:text-2xl font-bold text-gray-900 mb-2 md:mb-3 cursor-pointer text-blue-700 hover:underline"
...
function ResumeSubmissionForm({onClose}) {
    const [formData, setFormData] = useState({
        fullName: '',
        email: '',
        phone: '',
    ...
    const handleSubmit = async (e) => {
        ...
        const submitData = new FormData();
        submitData.append('jobTitle', formData.position || 'General Application');
        submitData.append('fullName', formData.fullName);
        submitData.append('email', formData.email);
        submitData.append('phone', formData.phone);
                ...
                {submitSuccess ? (
                    <div className="p-12 text-center relative z-10">
                        ...
                        <motion.p
                            ...
                            className="text-gray-600 mb-8 text-lg"
                        >
                            Thank you for your interest in joining Falx Lata. We'll review your resume and contact you if there's a match with our current or future openings.
                        </motion.p>
                        <motion.button
                            initial={{opacity: 0}}
                            animate={{opacity: 1}}
...
export default function CareersSection() {
    ...
    const [showResumeForm, setShowResumeForm] = useState(false); // State for showing resume form
    ...
    return (
        <>
            ...
            <div className="py-13 bg-gray-50 relative overflow-hidden">
                ...
                {showResumeForm && (
                    <ResumeSubmissionForm onClose={() => setShowResumeForm(false)} />
                )}
